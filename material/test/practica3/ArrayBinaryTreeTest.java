...
class ArrayBinaryTreeTest {
    ...
    void subTree() {
        ...
        // He tenido que cambiar el test de linkedbinarytree porque comparaba dos positions diferentes de dos arboles diferentes
        // Eso en arraybinarytree, por seguridad, no se puede hacer, se comparan los elementos en todos los casos
    ...
    void attachLeft() {
        ...
        // He tenido que modificar el test de linkedbinarytree porque no usa myTree y con arraybinarytree hace una infracción de seguridad
        // Le pasa a tree un position de t, inadmisible
        assertEquals('-', tree.left(pos[5]).getElement());
        assertEquals('1', tree.left(tree.left(pos[5])).getElement());
    }
    ...
    void attachRight() {
        ...
        // He tenido que modificar el test de linkedbinarytree porque no usa myTree y con arraybinarytree hace una infracción de seguridad
        // Le pasa a tree un position de t, inadmisible
        assertEquals('-', tree.right(pos[5]).getElement());
        assertEquals('1', tree.left(tree.right(pos[5])).getElement());
    }
