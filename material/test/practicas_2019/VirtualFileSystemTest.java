package material.test.practicas_2019;

import org.junit.jupiter.api.AfterEach;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;
import usecase.practicas_2019.VirtualFileSystem;
...
class VirtualFileSystemTest {
    ...
    private String path = "src/usecase/DirectorioRaiz";
    private String path2 = "src/usecase/DirectorioRaiz/SubdirectorioA";
    ...
    void getFilePath() {
        ...
        expected = "src\\usecase\\DirectorioRaiz";
        assertEquals(expected, output);

        output = vfs.getFilePath(3);
        expected = "src\\usecase\\DirectorioRaiz\\SubdirectorioA\\ArchivoB.ext";
        assertEquals(expected, output);

        vfs.loadFileSystem(path2);
        output = vfs.getFilePath(0);
        expected = "src\\usecase\\DirectorioRaiz\\SubdirectorioA";
        assertEquals(expected, output);
